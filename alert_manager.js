...
async function sendEmailAlert(payload) {
    ...
    if (payload.event === 'CAPACITY_EXHAUSTION') {
        ...
        emailBody = `<h2 style="color: ${isDown ? '#d9534f' : '#f0ad4e'};">Network Link Alert Triggered</h2>
            ...
            <br>
            <p style="font-size: 12px; color: #666;"><em>This is an automated message generated by the PostgreSQL trigger mechanism at Steniel Mindanao Packaging Corp.</em></p>
        `;
    }
